...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['emp_id'])) {
    ...
    $result = $conn->query("SELECT photo FROM employees WHERE emp_id='$emp_id'");
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-end bg-white" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="delete-employee.php">
